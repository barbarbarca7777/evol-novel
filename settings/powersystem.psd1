@{
    ...
    MythologyMapping = @{
        ...
        Norse = @(
            @{ Deity = 'ブリュンヒルデ'; Character = '式波アスカ・ラングレー'; Note = '参級→特級(続編)・炎双剣フレイムツインソード・属性型+具現型。解号「戦乙女(いくさおとめ)」は普通に読むが、作中では「戦乙女」という称号=ブリュンヒルデその人として認識されている。' }
    ...
    TechniqueDesign = @{
        ...
        FuriganaPolicy = '解号・技名の漢字のうち、素で読めない可能性が高い語(例: 奔れ=はしれ、戦乙女=いくさおとめ)は、本文での初出時のみ括弧書きで読みを添える。2回目以降は読み無しの表記に戻す。読みはあくまで通常の漢字の読み方であり、宿し神の固有名(ブリュンヒルデ等)への読み替え演出ではない。このpsd1内のKaigou欄自体には読みを含めない(正式表記を保つため)。2026-08-28、第3話中編で運用開始。'
    }
    ...
    ABand = @(
        ...
        @{ Character = '式波アスカ・ラングレー'; Host = 'ブリュンヒルデ'; Type = '属性+具現'; Kaigou = '燃えなさい――『戦乙女』'; Normal = '焔牙 / 緋輪 / 炎駆'; Ougi = '双焔断'; Final = '戦乙女・誓焔'; Role = '高速斬撃・前衛エース'; Note = '解号は「戦乙女」を普通に「いくさおとめ」と読んで叫ぶ(読み替え演出ではない)。ただし作中の認識としては「戦乙女」という称号=ブリュンヒルデその人を指す、という一対一のイメージで扱う。' }
